    ...
    public partial class ViewBookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[3].CommandText = "SELECT        ISBN, BookName, Publisher, PublishYear, Pages, AuthorName, Category" +
                "Name, LanguageName, Author, Category, Language\r\nFROM            ViewBook\r\nWHERE " +
                "       (BookName = @BOOKNAME) AND (AuthorName = @AUTHORNAME)";
            ...
            this._commandCollection[4].CommandText = "SELECT        ISBN, BookName, Publisher, PublishYear, Pages, AuthorName, Category" +
                "Name, LanguageName, Author, Category, Language\r\nFROM            ViewBook\r\nWHERE " +
                "       (ISBN = @ISBN)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByBookName(BookDS.ViewBookDataTable dataTable, string BOOKNAME) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual BookDS.ViewBookDataTable GetDataByBookName(string BOOKNAME) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((BOOKNAME == null)) {
                throw new global::System.ArgumentNullException("BOOKNAME");
            }
